...
public class TestSet {
	public static void main(String[] args) {
		...
		/*
		 * Set<Client> set4 = new TreeSet<>(); set4.add(new Client(1, "OMAR"));
		 * set4.add(new Client(3, "SAID")); set4.add(new Client(2, "HASSAN"));
		...
		Comparator<Client> c1 = new CodeComparator();
		Set<Client> set5 = new TreeSet<>(c1);
